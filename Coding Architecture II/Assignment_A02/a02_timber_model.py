# ========================================================================
# ASSIGNMENT A02:
# You have two options for this file:
# 1. Continue with your own work: Copy your code from
#    `a01_timber_model.py` (Assignment A01) here.
# 2. Use our provided solution: Rename the file `a02_timber_model_solved.py`
#    to `a02_timber_model.py`, which will overwrite this file.
# ========================================================================
...
class TimberModelCreator:
    ...
    def _create_beams(self) -> None:
        ...
        for edge in mesh.edges():
            print(edge)
            print("-")
            print(mesh.edge_attribute(edge, "centerline"))
            print("--")
            print(mesh.edge_attribute(edge, "centerline").length)
            print("---")

            centerline = mesh.edge_attribute(edge, "centerline")
            normal = mesh.edge_attribute(edge, "normal")

            print("length:", centerline.length)
