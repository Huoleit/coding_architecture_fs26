...
#    `a01_mesher.py` (Assignment A01) here.
# 2. Use our provided solution: Rename the file `a02_mesher_solved.py`
#    to `a02_mesher.py`, which will overwrite this file.
# ========================================================================
...
class TriMesher(BaseMesher):
    ...
    def __init__(self, u_count: int, v_count: int, brep: rg.Brep, closed: bool = True):
        super().__init__(u_count, v_count, brep=brep)
        self.closed = closed
