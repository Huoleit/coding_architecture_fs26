...
class TimberModelCreator:
    ...
    def _create_beams(self) -> None:
        ...
        #    Create a Beam from the centerline using the configured width/height
            beam = Beam.from_centerline(centerline, self.beam_width, self.beam_height, z_vector=normal)
    ...
    def _add_rules(self) -> None:
        ...
        self._rules.append(CategoryRule(TButtJoint, "interior", "boundary", max_distance = self.tolerance))
        ...
        self._rules.append(TopologyRule(JointTopology.TOPO_T,TStepJoint))
    ...
    def _apply_rules(self, process_joinery: bool) -> None:
        ...
        solver = JointRuleSolver(self._rules, max_distance=self.tolerance)
        ...
        if self.joining_errors:
            print(f"Joining errors found: {len(self.joining_errors)}")
